...
const WorkoutSessionSchema = CollectionSchema(
  ...
  links: {},
  embeddedSchemas: {
    r'WorkoutSessionLog': WorkoutSessionLogSchema,
...
int _workoutSessionEstimateSize(
  ...
  {
    final offsets = allOffsets[WorkoutSessionLog]!;
    for (var i = 0; i < object.exercises.length; i++) {
      final value = object.exercises[i];
      bytesCount +=
          WorkoutSessionLogSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  {
...
void _workoutSessionSerialize(
  ...
  writer.writeObjectList<WorkoutSessionLog>(
    offsets[2],
    allOffsets,
    WorkoutSessionLogSchema.serialize,
    object.exercises,
  );
...
WorkoutSession _workoutSessionDeserialize(
  ...
  object.exercises = reader.readObjectList<WorkoutSessionLog>(
        offsets[2],
        WorkoutSessionLogSchema.deserialize,
        allOffsets,
        WorkoutSessionLog(),
      ) ??
      [];
...
P _workoutSessionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (reader.readObjectList<WorkoutSessionLog>(
            offset,
            WorkoutSessionLogSchema.deserialize,
            allOffsets,
            WorkoutSessionLog(),
...
extension WorkoutSessionQueryObject
    on QueryBuilder<WorkoutSession, WorkoutSession, QFilterCondition> {
  QueryBuilder<WorkoutSession, WorkoutSession, QAfterFilterCondition>
      exercisesElement(FilterQuery<WorkoutSessionLog> q) {
    return QueryBuilder.apply(this, (query) {
...
extension WorkoutSessionQueryProperty
  ...
  QueryBuilder<WorkoutSession, List<WorkoutSessionLog>, QQueryOperations>
      exercisesProperty() {
    return QueryBuilder.apply(this, (query) {
...
const WorkoutSessionLogSchema = Schema(
  name: r'WorkoutSessionLog',
  id: -3205852374654219506,
  properties: {
  ...
  estimateSize: _workoutSessionLogEstimateSize,
  serialize: _workoutSessionLogSerialize,
  deserialize: _workoutSessionLogDeserialize,
  deserializeProp: _workoutSessionLogDeserializeProp,
);

int _workoutSessionLogEstimateSize(
  WorkoutSessionLog object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _workoutSessionLogSerialize(
  WorkoutSessionLog object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
WorkoutSessionLog _workoutSessionLogDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = WorkoutSessionLog();
...
P _workoutSessionLogDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension WorkoutSessionLogQueryFilter
    on QueryBuilder<WorkoutSessionLog, WorkoutSessionLog, QFilterCondition> {
  QueryBuilder<WorkoutSessionLog, WorkoutSessionLog, QAfterFilterCondition>
      exerciseIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
...
extension WorkoutSessionLogQueryObject
    on QueryBuilder<WorkoutSessionLog, WorkoutSessionLog, QFilterCondition> {
  QueryBuilder<WorkoutSessionLog, WorkoutSessionLog, QAfterFilterCondition>
...
void _workoutSetSerialize(
  ...
  writer.writeLong(offsets[0], object.feeling);
...
WorkoutSet _workoutSetDeserialize(
  ...
  object.feeling = reader.readLongOrNull(offsets[0]);
...
extension WorkoutSetQueryFilter
  ...
  QueryBuilder<WorkoutSet, WorkoutSet, QAfterFilterCondition> feelingIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'feeling',
      ));
  ...
  QueryBuilder<WorkoutSet, WorkoutSet, QAfterFilterCondition> feelingEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'feeling',
  ...
  QueryBuilder<WorkoutSet, WorkoutSet, QAfterFilterCondition> feelingLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkoutSet, WorkoutSet, QAfterFilterCondition> feelingBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<WorkoutSet, WorkoutSet, QAfterFilterCondition> indexEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'index',
  ...
  QueryBuilder<WorkoutSet, WorkoutSet, QAfterFilterCondition> indexGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkoutSet, WorkoutSet, QAfterFilterCondition> indexLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkoutSet, WorkoutSet, QAfterFilterCondition> indexBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,

...
int _exerciseEstimateSize(
  ...
  bytesCount += 3 + object.targetPart.length * 3;
  return bytesCount;
}
...
extension ExerciseQueryFilter
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> targetPartIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'targetPart',
        value: '',
...
extension ExerciseQuerySortBy on QueryBuilder<Exercise, Exercise, QSortBy> {
  ...
  QueryBuilder<Exercise, Exercise, QAfterSortBy> sortByTargetPart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'targetPart', Sort.asc);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterSortBy> sortByTargetPartDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'targetPart', Sort.desc);
    });
  }
}
...
extension ExerciseQuerySortThenBy
  ...
  QueryBuilder<Exercise, Exercise, QAfterSortBy> thenByTargetPart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'targetPart', Sort.asc);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterSortBy> thenByTargetPartDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'targetPart', Sort.desc);
    });
  }
...
extension ExerciseQueryWhereDistinct
  ...
  QueryBuilder<Exercise, Exercise, QDistinct> distinctByTargetPart(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'targetPart', caseSensitive: caseSensitive);
    });
  }
}
...
extension ExerciseQueryProperty
  ...
  QueryBuilder<Exercise, String, QQueryOperations> targetPartProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'targetPart');
    });
  }
}
